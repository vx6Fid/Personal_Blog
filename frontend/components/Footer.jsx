  ...
  return (
    <footer className="border-t border-borders bg-[#111111] backdrop-blur-sm py-8 px-4 sm:px-8 font-mono">
      <div className="max-w-6xl mx-auto">
        {/* Terminal-inspired profile section */}
        <div className="flex items-center mb-8 group">
          ...
          <div className="ml-4">
            ...
            <p className="text-secondary text-sm">Backend dev. Go + Linux. Exploring systems & scale
            </p>
          </div>
        </div>

        {/* Links Grid with terminal cues */}
        ...
        <div className="flex items-center justify-center sm:justify-start text-xs text-secondary">
          ...
          <div className="flex items-center">
            ...
            <span>Made with</span>
            <SquareTerminal className="mx-1 mb-1 w-4 h-4" />
          </div>
        </div>
      </div>
    </footer>
