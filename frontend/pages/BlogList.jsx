...
export default function BlogPage() {
  ...
  useEffect(() => {
    document.title = `vx6Fid Blogs — Software, Systems, Tools & More`;
    document
      .querySelector('meta[name="description"]')
      .setAttribute(
        "content",
        `A collection of engineering war stories, system deep-dives, and backend experiments—written by one developer who loves breaking things just enough to understand them.`,
      );
  }, [filteredBlogs]);
